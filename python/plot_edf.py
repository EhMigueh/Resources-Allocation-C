...
archivo = "./output/informe_entregas_edf.csv"
...
ax.set_title("Carta Gantt de Entregas por Vehículo - Estrategia EDF")
...
plt.savefig("./plots/carta_gantt_edf.png", dpi=150, bbox_inches="tight")
plt.close()
print("Carta Gantt guardada en ./plots/carta_gantt_edf.png\n")
